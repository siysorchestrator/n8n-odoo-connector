...
4.  **[VOZ DE SERVICIO]** La clave `mensaje` debe generarse con un tono de servicio, siguiendo esta lógica:
    * **Caso A:** Si las claves `nombre` y `correo` ambas tienen datos, el mensaje será: `"¡Muchas gracias! He registrado toda la información necesaria. En breve continuaremos con su solicitud."`
